    ...
    const where = search
      ? {
          OR: [
            ...
            { locationNote: { contains: search, mode: "insensitive" } },
            { subscriptionNote: { contains: search, mode: "insensitive" } },
          ],
        }
      : {};
...
export async function deleteCustomer(id) {
  try {
    ...
    return new GeneralResponse(true, "Customer deleted successfully.", customer);
  } catch (e) {
    return new GeneralResponse(false, e.message || "Error", null);
  }
}