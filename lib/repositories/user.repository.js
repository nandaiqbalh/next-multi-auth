...
/**
 * Buat user baru.
 * @param {{ name: string, username?: string, phone?: string, email: string, password: string, role?: "BUYER"|"ADMIN" }} data
 * @returns {Promise<import("@prisma/client").User>}
 */
export async function createUser({ name, username, phone, email, password, role = "BUYER" }) {
  try {
